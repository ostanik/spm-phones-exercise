...
private extension String {
    ...
    var valid: Bool {
        return self.validPrefix && self.onlyNumbers && self.validLength
    }
    ...
    func remove(_ identifier: AreaIdentifier) -> String {
    ...
    func lenght(in range: ClosedRange<Int>) -> Bool {
